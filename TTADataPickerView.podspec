...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "TobyoTenma"
  # s.authors            = { "TobyoTenma" => "tmtbo@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/TobyoTenma"
  ...
  s.source       = { :git => "https://github.com/KameraSui/TTADataPickerView.git", :tag => "#{s.version}" }
